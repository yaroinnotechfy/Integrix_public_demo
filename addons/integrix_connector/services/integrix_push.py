...
class IntegrixPush(models.AbstractModel):
    ...
    def _cfg(self):
        ...
        if not cfg or not (cfg.base_url and cfg.api_email and cfg.api_password and cfg.company_id):
            raise UserError(_("Configure Integri-x Settings first (Base URL, API Email/Password, Company ID)."))
        return cfg
